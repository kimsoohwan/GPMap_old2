...
public:
																	  ...
																	  const GP::DlibScalar		minValue = 1e-15)
	{
		...
		// trainer
		GP::DlibScalar sumNegLogPredProb = GP::TrainerUsingApproxDerivatives<OctoMap>::train<GP::BOBYQA, GP::NoStopping>(logDlib, *this, maxIter, minValue);
															  ...
															  const GP::DlibScalar				minValue = 1e-15)
	{
		...
		// trainer
		GP::DlibScalar negEvalAccu = GP::TrainerUsingApproxDerivatives<OctoMap>::train<GP::BOBYQA, GP::NoStopping>(logDlib, *this, maxIter, minValue);
	...
	GP::DlibScalar operator()(const GP::DlibVector &logDlib) const
	{
		...
		// log file
		LogFile logFile;
		logFile << "(" << PLSC::mean << ", "  << PLSC::var  << ") : accuracy = " << -neg_accuracy << " = "
